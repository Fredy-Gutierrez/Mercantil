...
class ModeloMantenimientos{
	...
	static public function mdlIngresarMantenimiento($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(fecha_servicio,nombre_taller,kilometraje,descripcion,nombre_mecanico,precio,proximo_servicio ) VALUES (:fecha_servicio,:nombre_taller,:kilometraje,:descripcion,:nombre_mecanico,:precio,:proximo_servicio)");
	...
	static public function mdlEditarMantenimiento($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET fecha_servicio = :fecha_servicio,nombre_taller = :nombre_taller,kilometraje = :kilometraje,descripcion =:descripcion,nombre_mecanico = :nombre_mecanico,precio = :precio,proximo_servicio = :proximo_servicio WHERE ID_MANTENIMIENTO = :id");
